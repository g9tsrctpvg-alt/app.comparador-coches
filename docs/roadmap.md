...
| Alta de `jeep-compass`: faltan las fotos de **frontal**, **lateral**, **trasera** y **maletero** (`check:photos` en verde con 1 de las 5 vistas), y la de **interior** es del Compass eléctrico, no del e-Hybrid 145 que puntúa la ficha. Los cuatro orígenes se agotaron: Commons solo tiene 3/4 de la generación J4U, `jeep.es` responde 403, el configurador oficial solo publica el eléctrico —cuya parrilla cerrada no es la de esta motorización— y la galería del concesionario Quadis resultó ser de la **generación anterior (MP)** pese a anunciar el modelo nuevo | 2026-08-24 | Encontrar fotos del e-Hybrid de la generación J4U en un importador o concesionario oficial español (origen 4), verificando el chasis antes de aceptarlas |
...
| Alta de `honda-zr-v`: faltan las fotos de **frontal** y **maletero** (`check:photos` en verde con 3 de las 5 vistas) — Wikimedia Commons solo tiene el acabado Advance en tres cuartos frontal y trasero (no rectos) del mismo fotógrafo, y ninguna fuente consultada publica el maletero abierto de este acabado. La de **interior** es de un ZR-V e:HEV expuesto en el Auto Zürich 2023, acabado sin confirmar como Advance —usada con conformidad expresa del usuario (2026-09-01) para la valoración de estética, pese a no cumplir el criterio habitual de verificación de acabado— | 2026-09-01 | Encontrar frontal recto y maletero abierto del acabado Advance en la sala de prensa de Honda, el configurador oficial o un concesionario (orígenes 1, 3 y 4 de `photo-sourcing.md`); sustituir el interior por uno confirmado del Advance si aparece |
