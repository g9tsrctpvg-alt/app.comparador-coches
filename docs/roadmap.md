...
| `product/0035` (P5) — los pesos salen de elegir coches, y el **ADR 0011** que sostiene su método: los dos `approved` el 2026-09-01, pendientes de implementar | *Propuestas de evolución*, abajo |
