...
| Asunto | Detalle en |
| --- | --- |
| `product/0014` se queda en `implemented`: su criterio de dos columnas a 320px quedó **obsoleto** al retirar `product/0023` la tabla a ese ancho; falta decidir su estado | *Deudas abiertas* |
