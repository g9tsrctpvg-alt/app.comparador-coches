...
| Alta de `toyota-rav4-hev`: **espacio de piernas** (960 mm) y **anchura de hombros** (1.433 mm) de la segunda fila no salen de las mediciones propias de km77 —que todavía no ha medido esta generación, a la venta en España desde enero de 2026— sino de la ficha de un concesionario de EE. UU. (Toyota of Glendale), con el protocolo SAE J1100 en vez del «respaldo a respaldo» que usa el resto del catálogo; decisión expresa del usuario tras confirmar que no había otra fuente disponible. No son directamente comparables con el resto de candidatos. Tampoco declara **diámetro de giro entre bordillos** ni **carga máxima en techo** —ninguna fuente consultada los publica todavía para esta generación—, ni **valor residual a 5 años** —modelo recién lanzado, sin histórico de reventa—. El **mantenimiento anual** (221 €/año) es estimado: media de las cinco revisiones oficiales M1-M5 de un concesionario de Madrid (carwow.es), no una tarifa anual desglosada por Toyota | 2026-09-14 | Volver a comprobar cuando km77 publique sus mediciones propias de la generación XA60; encontrar el diámetro entre bordillos y la carga en techo en documentación técnica de Toyota; esperar a que el RAV4 2026 tenga histórico de mercado de segunda mano a 5 años; encontrar un coste de mantenimiento desglosado por revisión |
