...
| `product/0014` tiene 37 de las 60 fotos posibles (Wikimedia Commons, `check:photos` en verde). Solo `toyota-corolla-cross` tiene las cinco vistas. Faltan: **maletero** en los once modelos restantes (`kia-ev3`, `hyundai-kona-hev`, `hyundai-kona-electrico`, `bmw-x1-xdrive25e`, `alfa-romeo-tonale`, `kia-sportage-hev`, `honda-civic-e-hev`, `lexus-nx-350h`, `mazda-cx-5`, `honda-cr-v-e-hev`, referencia `alfa-romeo-giulietta`); **interior** en `hyundai-kona-hev`, `hyundai-kona-electrico`, `bmw-x1-xdrive25e`, `alfa-romeo-tonale`, `kia-sportage-hev`, `honda-civic-e-hev`, `mazda-cx-5` y la referencia; **lateral** en `hyundai-kona-electrico`, `honda-civic-e-hev` y `lexus-nx-350h`; **trasera** en `honda-cr-v-e-hev`. Varias de las fotos que sí hay son en 3/4, no estrictas, por decisión del 2026-08-06 de relajar el lateral a «casi perfil» ante la escasez de fotografía de aficionado en 90º exacto | 2026-08-06 | Completar las 23 vistas que faltan —maletero sobre todo, hoy solo lo tiene el Corolla Cross—, y decidir si las vistas en 3/4 se sustituyen por otras más estrictas cuando aparezcan mejores fuentes |
