...
Con eso, lo único que le queda a fase 2 es `technical/0003`: portar el
validador de documentación a TypeScript para que la CI deje de arrancar dos
*runtimes*. Después, fase 3.
