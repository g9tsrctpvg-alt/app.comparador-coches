...
| `product/0038` y `product/0039` en `draft`, esperando el gate humano; la segunda, con una decisión abierta —los anclajes de su escala— que hay que cerrar antes | *Propuestas de evolución* |
...
| P18 | **El espacio de atrás, medido en vez de inferido**: `habitabilidad` puntúa la batalla como proxy del sitio de quien va detrás, y el propio doc de estado reconoce que reparte entre habitáculo y vanos | `en spec` | **Redactada como `product/0039`** el 2026-09-06, en `draft` y **con una decisión abierta**: los dos anclajes de la escala nueva, que hay que fijar con el criterio del ADR 0010 antes de que pueda pasar el gate. Detectada el 2026-09-06. La ficha de *mediciones propias* de km77 —**la misma fuente que el catálogo ya usa** para la anchura de hombros— publica en la segunda fila «Distancia del respaldo al respaldo delantero», «Altura al techo», «Anchura hombros máxima/mínima» e «Isofix. Distancia entre anclajes», y en el maletero anchura, profundidad y «Altura de borde de carga»; comprobado fila a fila sobre la ficha del Kia EV3. Sustituir la batalla por la medida directa no pide ninguna fuente nueva —la página ya se abre coche a coche para otro dato— y de paso cierra la deuda de hombros mínimos mezclados con máximos, porque esa tabla publica las dos. Que la tabla existe para los veintiún registros no es una apuesta: los veintiuno ya citan esa misma ficha para la anchura de hombros, comprobado registro a registro. La spec cambia la batalla por la medida directa manteniendo el 50/50, re-declara los hombros desde una fila declarada y la misma para todos, y deja fuera la altura al techo como tercer sumando |
