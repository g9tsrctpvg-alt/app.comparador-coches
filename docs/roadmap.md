...
| P4 | **Criterios eliminatorios** además del presupuesto: largo máximo, maletero mínimo, autonomía mínima, altura de acceso | `en spec` | `product/0031`. Un coche que incumple un imprescindible no debería ganar por puntos; el precio es hoy el único filtro duro |
