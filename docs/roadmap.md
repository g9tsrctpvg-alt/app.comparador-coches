...
| `product/0014` tiene **47 de las 60 fotos posibles** (Wikimedia Commons, `check:photos` en verde). El **interior está completo** en los doce, y `toyota-corolla-cross` y `mazda-cx-5` tienen las cinco vistas. Faltan: **maletero** en diez (`kia-ev3`, `hyundai-kona-hev`, `hyundai-kona-electrico`, `bmw-x1-xdrive25e`, `alfa-romeo-tonale`, `kia-sportage-hev`, `honda-civic-e-hev`, `lexus-nx-350h`, `honda-cr-v-e-hev`, referencia `alfa-romeo-giulietta`) y **lateral** en `hyundai-kona-electrico`, `honda-civic-e-hev` y `lexus-nx-350h`. El maletero es el hueco duro: Wikimedia casi no tiene esa vista y las búsquedas por «trunk/boot/Kofferraum» en cinco idiomas no devuelven nada útil. Varias de las fotos que sí hay son en 3/4, no estrictas, por decisión del 2026-08-06 de relajar el lateral a «casi perfil» | 2026-08-06, revisada el 2026-08-07 | Completar las 13 vistas que faltan —maletero sobre todo—, probablemente fuera de Wikimedia, y decidir si las vistas en 3/4 se sustituyen cuando aparezcan mejores fuentes |
