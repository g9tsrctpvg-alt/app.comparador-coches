...
| Documentación: dos recuentos obsoletos que el repaso del 2026-09-06 no pudo corregir sin inventar o sin spec | *Deudas abiertas* |
| `product/0041` — la garantía sale de la nota de fiabilidad: `draft`, esperando el gate humano | *Propuestas de evolución* (P21) |
...
| Dos recuentos obsoletos que el repaso del 2026-09-06 dejó sin corregir, cada uno por un motivo distinto. En `docs/estado/dominio.md`, los anclajes de `fiabilidad` afirman que «nueve de los once candidatos» salen de marcas del tercio alto de las 39 de la OCU: el catálogo son hoy dieciocho publicados, pero rehacer la cuenta exige el ranking completo de esas 39 marcas, que el catálogo no guarda, y estimarlo sería inventar. En `src/domain/scoring/scoreGap.ts` (línea 145) un comentario habla de «las siete entradas de `AXIS_ORDER`», que desde `product/0037` son ocho: no se toca porque es código de producción y no hay spec detrás | 2026-09-06 | Recuperar el ranking OCU por marca y rehacer la cuenta sobre los publicados; el comentario, en el próximo cambio con spec que toque `scoring/` |
