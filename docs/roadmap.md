...
| `product/0036` — el representante de la calibración es extremo, y quien elige no puede decir qué eje decidió: `draft`, pendiente del gate humano | *Propuestas de evolución*, abajo |
