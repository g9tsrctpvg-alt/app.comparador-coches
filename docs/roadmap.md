...
| Asunto | Detalle en |
| --- | --- |
| `technical/0006` — el estado terminal para una spec que no se va a verificar: ADR y spec por redactar | *Fase 5* |
